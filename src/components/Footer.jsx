export default function Footer() {
  return (
    <footer className="py-8" style={{ backgroundColor: "#999999" }}>
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="flex flex-col md:flex-row justify-center items-center mb-4 space-y-4 md:space-y-0 md:space-x-8 text-center">
          <a href="mailto:linhaverde.sede@ibama.gov.br" className="text-sm font-bold hover:underline" style={{ color: "#FFFFFF" }}>
            Email
          </a>
          <a href="#" className="text-sm font-bold hover:underline" style={{ color: "#FFFFFF" }}>
            Sobre‑nós
          </a>
          <a href="#" className="text-sm font-bold hover:underline" style={{ color: "#FFFFFF" }}>
            Contato
        ...
        <div className="flex justify-center space-x-6">
          {/* Ícone do Instagram */}
          <a href="#" className="hover:text-emerald-500 transition" style={{ color: "#FFFFFF" }} aria-label="Instagram">
          ...
          {/* Ícone do WhatsApp */}
          <a href="#" className="hover:text-emerald-500 transition" style={{ color: "#FFFFFF" }} aria-label="WhatsApp">
            <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
